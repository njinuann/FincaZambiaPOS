...
public class QFactory
{
    ...
    public void setAttribute(MBeanServer server, ObjectName objectName,
            ...
            throws ConfigurationException
    {
        try
        {
            ...
            {
                col.add(getObject((Element) childs.next()));
            }
            return col;
        }
        catch (Exception e1)
            ...
            throws ConfigurationException
    {
        try
        {
            ...
            {
                Method method = obj.getClass().getMethod(m, (Class<?>) null);
