...
public abstract class ISOBasePackager implements ISOPackager, LogSource
{
    ...
    public int unpack(ISOComponent m, byte[] b) throws ISOException
    {
        ...
        try
        {
            ...
            //System.err.println("header .... " + Arrays.toString(((ISOMsg) m).getHeader()));
            ...
            if (emitBitMap())
            {
                ...
                // njinu 
                System.err.println("bitmap = " + bmap.toString());
                if (logger != null)
                {
            ...
            for (int i = getFirstField();i < maxField;i++)
            {
                try
                {
                    ...
                    if (bmap == null || bmap.get(i))
                    {
                        ...
                        if (logger != null)
                        {
                           ...
                           //njinu System.out.println(" field >> " + i + " has " + c.getValue() + " <> " + fld[i].getLength());
                ...
                catch (ISOException e)
                {
                    ISOComponent c = fld[i].createComponent(i);
                    //njinu
                    System.err.println(" 1field >> " + i + " has " + c.getValue() + " <> " + fld[i].getLength());
