...
public class ISOException extends Exception implements Loggeable
{
    ...
    public void dump(PrintStream p, String indent)
    {
        ...
        if (nested != null)
        {
            ...
            else
            {
                ...
                p.println(inner + "\t" + "<message>" + nested.getMessage() + "</message>");
                p.println(inner + "\t" + "<stacktrace>");
                for (StackTraceElement s : ((Throwable) nested).getStackTrace())
                {
                    p.println(inner + "\t" + "\t" + "at " + s.toString());
                }
                p.println(inner + "\t" + "</stacktrace>");
                p.println(inner + "</nested-exception>");
            }
    ...
    public String toString()
    {
        ...
        if (nested != null)
        {
            buf.append(" (").append(nested.toString()).append(")");
        }
        return buf.toString();
    }
