 ...
 * @author Pecherk
 */
public final class TCPanelMOB extends javax.swing.JPanel
{

    private TCValueMOB tCValue = null;
    private EIChargeMOB eICharge = new EIChargeMOB();
    ...
    private void initComponents()
    {
        ...
        tpLedgerField = new javax.swing.JTextField();
        jLabel23 = new javax.swing.JLabel();
        sharePercentageField = new javax.swing.JTextField();
        ...
        waiverConditionBox = new javax.swing.JComboBox<String>();
        ...
        chargeTree.setCellRenderer(new Mobile.TRendererMOB());
        ...
        jLabel22.setText("3rd P. Ledger");

        tpLedgerField.addFocusListener(new java.awt.event.FocusAdapter()
        {
            public void focusLost(java.awt.event.FocusEvent evt)
            {
                tpLedgerFieldFocusLost(evt);
            }
        });

        jLabel23.setText("Share %age");

        sharePercentageField.setHorizontalAlignment(javax.swing.JTextField.TRAILING);
        sharePercentageField.addFocusListener(new java.awt.event.FocusAdapter()
        {
            public void focusLost(java.awt.event.FocusEvent evt)
            {
                sharePercentageFieldFocusLost(evt);
            }
        });
        ...
        detailsPanelLayout.setHorizontalGroup(
            ...
            .addGroup(detailsPanelLayout.createSequentialGroup()
                ...
                .addGroup(detailsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(sharePercentageField))
                ...
                .addGroup(detailsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tpLedgerField)
                    .addComponent(taxNameField)
                    .addComponent(descriptionField, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 256, Short.MAX_VALUE)
            ...
            .addGroup(detailsPanelLayout.createSequentialGroup()
                ...
                .addGroup(detailsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(detailsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(sharePercentageField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(detailsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(tpLedgerField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        waiversTree.setCellRenderer(new Mobile.TRendererMOB());
        ...
        tiersTree.setCellRenderer(new Mobile.TRendererMOB());
        ...
        currencyTree.setCellRenderer(new Mobile.TRendererMOB());
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(detailsPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    {//GEN-HEADEREND:event_cancelButtonActionPerformed
        // TODO add your handling code here:
        PHMain.phFrame.hideMobChargesDialog();
    ...
    public void setChargeTree()
    {
        ...
        Object[] chargeCodes = PHController.getMobCharges().keySet().toArray();
        Arrays.sort(chargeCodes);
        for (Object chargeCode : chargeCodes)
        {
            rootNode.add(new DefaultMutableTreeNode(chargeCode + "~" + PHController.getMobCharges().get(chargeCode).getDescription()));
        }
    ...
    {//GEN-HEADEREND:event_saveButtonActionPerformed
        ...
        if (isChargeComplete())
        {
            ...
            eICharge.setLastModifiedBy(EILoginMOB.getAdminName());
            eICharge.setModule(PHController.mobChannelCode);
            tCValue.setChargeType(chargeTypeBox.getSelectedItem().toString());

            eICharge.setTpLedger(tpLedgerField.getText().trim());
            eICharge.setTpSharePercentage(new BigDecimal(sharePercentageField.getText().trim()));
            ...
            if (!taxLedgerField.getText().contains("***") || !chargeLedgerField.getText().contains("***"))
            {
                JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "GL Must be Masked", "GL NAME", JOptionPane.INFORMATION_MESSAGE);
            }
            if ("Save".equals(saveButton.getText()) ? JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(PHMain.phFrame.chargesDialogMob, "Are you sure you want to save this new charge?", "Confirm", JOptionPane.YES_NO_OPTION)
                    : JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(PHMain.phFrame.chargesDialogMob, "Are you sure you want to save changes to this charge?", "Confirm", JOptionPane.YES_NO_OPTION))
            {
                PHController.getMobCharges().put(eICharge.getChargeCode(), eICharge);
                if (tDClient.upsertCharge(eICharge))
                {
                    JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Charge saved successfully.");
                }
                else
                {
                    JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Unable to save charge. Please refer to log for more details.", "Save Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    ...
    private boolean isChargeComplete()
    {
        ...
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Charge description required.");
            return false;
        }

        if (chargeLedgerField.getText().trim().equals(""))
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Charge ledger required.");
            return false;
        }

        if (taxLedgerField.getText().trim().equals(""))
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Tax ledger required.");
            return false;
        }

        if (taxPercentageField.getText().trim().equals(""))
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Tax percentage required.");
            return false;
        }

        if (taxNameField.getText().trim().equals(""))
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Tax narration required.");
            return false;
        }

        if (valueField.getText().trim().equals(""))
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Charge value (amount or percentage) required.");
            return false;
        }
        ...
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Invalid charge amount or percentage.");
            return false;
        }
        ...
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "You must set the charge value for primary currency [" + PHController.PrimaryCurrencyCode + "].");
            return false;
        }
        ...
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Charge minimum amount required.");
            return false;
        }
        ...
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Invalid charge minimum amount.");
            return false;
        }

        if (maxAmountField.getText().trim().equals(""))
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Charge maximum amount required.");
            return false;
        }
        ...
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Invalid charge maximum amount.");
            return false;
        }

        if (Double.parseDouble(maxAmt) < Double.parseDouble(minAmt))
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Maximum amount cannot be less than minimum amount.");
            return false;
        }

        for (TCValueMOB tcv : eICharge.getValues().values())
        {
            if ("Tiered".equals(tcv.getChargeType()))
            {
                if (tcv.getTiers().isEmpty())
                {
                    JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "You must save atleast one tier for " + tcv.getCurrency() + " charge which is tiered [or change charge type].", "Missing Tiers", JOptionPane.ERROR_MESSAGE);
                    return false;
                }
            }
        }
    ...
    {//GEN-HEADEREND:event_tierButtonActionPerformed
        // TODO add your handling code here:
        TCTierMOB tXTier = new TCTierMOB();
        if (tierMaxAmountField.getText().trim().equals(""))
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Tier maximum amount required.");
            return;
        }
        ...
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Invalid tier maximum amount.");
            return;
        }
        ...
        if (tierButton.getText().equals("Save Tier"))
        {
            ...
            {
                JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Tier charge amount required.");
                return;
            }

            if (!isNumberValid(tierCharge))
            {
                JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Invalid tier charge amount.");
                return;
            }
            ...
            {
                JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Tier already exists.");
                return;
            }
            ...
            if (tCValue.getTiers().containsKey(tXTier.getTierCeiling()))
            {
                JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Tier saved successfully.");
                eICharge.getValues().put(tCValue.getCurrency(), tCValue);
            ...
            {
                JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Unable to save tier. Please refer to log for more details.", "Save Error", JOptionPane.ERROR_MESSAGE);
            }
        }
        else
        {
            ...
            if (!tCValue.getTiers().containsKey(tXTier.getTierCeiling()))
            {
                JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Tier removed successfully.");
                eICharge.getValues().put(tCValue.getCurrency(), tCValue);
                displayTiers(tCValue.getCurrency());
            }
            else
            {
                JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Failed to remove tier. Please refer to log for more details.", "Delete Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    {//GEN-HEADEREND:event_waiverButtonActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Select the account product to which this waiver will apply.");
            return;
        }

        if (!isNumberValid(waivedPercentageField.getText().trim()))
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Invalid waiver percentage [it must be a number between 0 and 100].");
            return;
        }

        if (Double.parseDouble(waivedPercentageField.getText().trim()) <= 0 || Double.parseDouble(waivedPercentageField.getText().trim()) > 100)
        {
            JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Waiver percentage MUST be a number greater than 0 and less than 100.");
            return;
        }
        ...
        if (waiverButton.getText().equals("Save Waiver"))
        {
            ...
            {
                JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Waiver saved successfully.");
                setWaiversTree();
                showWaiver(String.valueOf(tXWaiver.getProductId()));
            }
            else
            {
                JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Failed to save waiver. Please refer to log for more details.", "Save Error", JOptionPane.ERROR_MESSAGE);
            }
        }
        else
        {
            ...
            if (!eICharge.getWaivers().containsKey(tXWaiver.getProductId()))
            {
                JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Waiver removed successfully.");
                setWaiversTree();
                showWaiver("Add Waiver");
            }
            else
            {
                JOptionPane.showMessageDialog(PHMain.phFrame.chargesDialogMob, "Failed to remove waiver. Please refer to log for more details.", "Delete Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void sharePercentageFieldFocusLost(java.awt.event.FocusEvent evt)//GEN-FIRST:event_sharePercentageFieldFocusLost
    {//GEN-HEADEREND:event_sharePercentageFieldFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_sharePercentageFieldFocusLost
    ...
    {//GEN-HEADEREND:event_chargeLedgerFieldFocusLost
        // TODO add your handling code here:
        if (!chargeLedgerField.getText().isEmpty())
        {
            validateGl(chargeLedgerField.getText(), chargeLedgerField);
        }
    ...
    {//GEN-HEADEREND:event_taxLedgerFieldFocusLost
        // TODO add your handling code here:
        if (!taxLedgerField.getText().isEmpty())
        {
            validateGl(taxLedgerField.getText(), taxLedgerField);
        }
    }//GEN-LAST:event_taxLedgerFieldFocusLost

    private void tpLedgerFieldFocusLost(java.awt.event.FocusEvent evt)//GEN-FIRST:event_tpLedgerFieldFocusLost
    {//GEN-HEADEREND:event_tpLedgerFieldFocusLost
        // TODO add your handling code here:
        if (!tpLedgerField.getText().isEmpty())
        {
            validateGl(tpLedgerField.getText(), tpLedgerField);
        }

    }//GEN-LAST:event_tpLedgerFieldFocusLost
    private void validateGl(String glNumber, JComponent jComponent)
    {
        ...
        {
            BalloonTip myBalloonTip = new BalloonTip(jComponent, new JLabel(tDClient.capitalize(glLedger[0][0].toString())), edgedLook, Orientation.RIGHT_BELOW, AttachLocation.ALIGNED, 40, 20, true);
        }
        else
        {
            BalloonTip myBalloonTip = new BalloonTip(jComponent, new JLabel("Invalid GL or Inactive GL"), edgedLook2, Orientation.RIGHT_BELOW, AttachLocation.ALIGNED, 40, 20, true);
        }
    }
    ...
    private void displayValue(String currencyCode)
    {
        ...
        tCValue = eICharge.getValues().containsKey(currencyCode) ? eICharge.getValues().get(currencyCode) : new TCValueMOB();
    ...
    public void displayCharge()
    {
        ...
        if (rootNode.getChildCount() > 0)
        {
            ...
            eICharge = "Add Charge".equalsIgnoreCase(selectedNode.getUserObject().toString()) ? null : PHController.getMobCharges().get(selectedNode.getUserObject().toString().split("~")[0].trim());
            if (eICharge == null)
            {
                eICharge = new EIChargeMOB();
                tCValue = new TCValueMOB();
                eICharge.setChargeCode("A" + String.format("%02d", (PHController.getMobCharges().size() + 1)));
                ...
                tpLedgerField.setText("");
                sharePercentageField.setText("");
            ...
            {
                tCValue = eICharge.getValues().containsKey(PHController.PrimaryCurrencyCode) ? eICharge.getValues().get(PHController.PrimaryCurrencyCode) : new TCValueMOB();
                chargeCodeField.setText(eICharge.getChargeCode());
                descriptionField.setText(eICharge.getDescription());
                ...
                tpLedgerField.setText(eICharge.getTpLedger());
                sharePercentageField.setText(eICharge.getTpSharePercentage().toPlainString());
    ...
    private void displayTier()
    {
        ...
        if (selectedTierNode != null)
        {
            ...
            else
            {
                ...
                for (TCTierMOB tier : tCValue.getTiers().values())
                {
    ...
    private void setTierFloors(String currency)
    {
        ...
        if (tiers.length > 0)
        {
            ...
            {
                ((TCTierMOB) tier).setTierFloor(floor);
                eICharge.getValues().get(currency).getTiers().put(((TCTierMOB) tier).getTierCeiling(), ((TCTierMOB) tier));
                floor = ((TCTierMOB) tier).getTierCeiling().add(new BigDecimal(0.01).setScale(2, RoundingMode.DOWN));
            }
        }
        PHController.getMobCharges().put(eICharge.getChargeCode(), eICharge);
    }
    ...
    public void setWaiversTree()
    {
        ...
        HashMap<Integer, TCWaiverMOB> waiversMap = eICharge.getWaivers();
    ...
    private void displayWaiver()
    {
        ...
        if (selectedWaiverNode != null)
        {
            ...
            else
            {
                ...
                TCWaiverMOB waiver = eICharge.getWaivers().get(Integer.parseInt(selectedWaiver.split("~")[0].trim()));
                if (waiver != null)
                {
    ...
    private javax.swing.JTextField sharePercentageField;
    ...
    private javax.swing.JTextField tpLedgerField;
