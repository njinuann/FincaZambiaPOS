 ...
 * @author Pecherk
 */
public class TMPanelMOB extends javax.swing.JPanel
{
    ...
    private TMAccountMOB tMAccount = new TMAccountMOB();
    ...
    private void initComponents()
    {
        ...
        currencyTree.setCellRenderer(new TRendererMOB());
        ...
        terminalsTree.setCellRenderer(new TRendererMOB());
    ...
    private void displayTerminal()
    {
        ...
        if (selectedTerminalNode != null)
        {
            ...
            else if (selectedNode instanceof EITerminalMOB)
            {
                eITerminal = (EITerminalMOB) selectedNode;
    ...
    public void showTerminalsDialog()
    {
        ...
        {
            terminalsDialog = new JDialog(PHMain.phFrame, PHController.MobModule + " Terminals");
    ...
    {//GEN-HEADEREND:event_saveButtonActionPerformed
        ...
        else
        {
            ...
            eITerminal.setChannelCode(PHController.mobChannelCode);
            ...
            eITerminal.setModifiedBy(EILoginMOB.getAdminName());
    ...
    private void verifyAccount()
    {
        ...
        if (!"".equals(acctNoField.getText().trim()))
        {
            ...
            CNAccountMOB cNAccount = isBranchTerminal ? tDClient.queryGLAccount(acctNoField.getText().trim()) : tDClient.queryDepositAccount(acctNoField.getText().trim());
    ...
    public void searchTerminals()
    {
        ...
        for (EITerminalMOB terminal : PHController.getMobTerminals().values())
        {
    ...
    private void showTerminal(String ID)
    {
        ...
        while (child != null)
        {
            if (child.getUserObject() instanceof EITerminalMOB)
            {
                if (((EITerminalMOB) child.getUserObject()).getTerminalId().equalsIgnoreCase(ID))
                {
