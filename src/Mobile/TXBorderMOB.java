 ...
 * @author Pecherk
 */
public class TXBorderMOB extends TitledBorder
{
    protected JComponent component;

    public TXBorderMOB(JComponent component)
    {
        this(null, component, LEFT, TOP);
    }

    public TXBorderMOB(Border border)
    {
        this(border, null, LEFT, TOP);
    }

    public TXBorderMOB(Border border, JComponent component)
    {
        this(border, component, LEFT, TOP);
    }

    public TXBorderMOB(Border border, JComponent component, int titleJustification, int titlePosition)
    {
