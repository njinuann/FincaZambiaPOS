 ...
 * @author Pecherk
 */
public class EILoginMOB extends javax.swing.JPanel
{
     ...
     * @param tDClient
     */
    public EILoginMOB(TDClientMOB tDClient)
    {
    ...
    private void loginUser()
    {
        ...
        else
        {
            ...
            {
                PHMain.mobBridgeLog.info(getAdminName() == null ? "Login failed. User [ " + getUserID() + " ], Module [ " + getModule() + " ]" : "Login successful. User [ " + getUserID() + " ], Name [ " + getAdminName() + " ], Module [ " + getModule() + " ]");
            }
