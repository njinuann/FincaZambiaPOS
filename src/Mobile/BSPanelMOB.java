 ...
 * @author Pecherk
 */
public final class BSPanelMOB extends javax.swing.JPanel
{
    public final String MODULE;
    BRMOBSetting bRSetting = new BRMOBSetting();
    private TDClientMOB tDClient = new TDClientMOB();
    private HashMap<String, BRMOBSetting> settings = new HashMap<>();
     ...
     * @param module
     */
    public BSPanelMOB(String module)
    {
        this.MODULE = module;
        initComponents();
        setSettingTree();
    ...
    private void initComponents()
    {
        ...
        settingTree.setCellRenderer(new Mobile.TRendererMOB());
    ...
    {//GEN-HEADEREND:event_saveSettingButtonActionPerformed
        ...
        if (isSettingComplete())
        {
            ...
            if (proceed)
            {
                ...
                bRSetting.setLastModifiedBy(EILoginMOB.getAdminName());
                if (gettDClient().upsertSetting(bRSetting))
                {
                    setSettingTree();
                    PHController.queryMobSettings();
    ...
    public void updateDisplay()
    {
        ...
        if (settingNode != null)
        {
            if (settingNode.getUserObject() instanceof BRMOBSetting)
            {
                displaySetting((BRMOBSetting) settingNode.getUserObject());
            }
            else
            {
                getNewSetting();
    ...
    private void displaySetting(BRMOBSetting setting)
    {
        bRSetting = setting;
     ...
     * @return the settings
     */
    public HashMap<String, BRMOBSetting> getSettings()
    {
        return settings;
    }
     ...
     */
    public void setSettings(HashMap<String, BRMOBSetting> settings)
    {
