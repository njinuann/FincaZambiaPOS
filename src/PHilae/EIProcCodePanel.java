 ...
 * @author Pecherk
 */
public class EIProcCodePanel extends javax.swing.JPanel
{
    ...
    private void initComponents()
    {
        ...
        moduleBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "POS", "MOB" }));

        buBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pick Creation Branch" }));

        jLabel5.setText("Proc Type");

        procTypeBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "DR", "CR", "TFR" }));
    ...
    public void showProcCodeDialog()
    {
        ...
        {
            procCodeDialog = new JDialog(PHMain.phFrame, PHController.posModule + " Processing Codes");
    ...
    private void verifyProcCode()
    {
        String procCode = codeField.getText().trim();
        if (PHController.getPosProcessingCode().containsKey(procCode))
        {
    ...
    public void searchProcCode()
    {
        ...
        for (EIProCodesMOB procCode : PHController.getPosProcessingCode().values())
        {
    ...
    {
        PHController.loadPosProcessingCodes();
...
//        }
        ...
        PHController.getPosProcessingCode().values().stream().map((procCode) -> new DefaultMutableTreeNode(procCode)).forEach((node)
                ->
                {
                    procCodeRootNode.add(node);
                });
