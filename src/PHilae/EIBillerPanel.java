 ...
 * @author Pecherk
 */
public class EIBillerPanel extends javax.swing.JPanel
{
    ...
    private void initComponents()
    {
        ...
        moduleBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "MOB", "POS" }));
    ...
    public void showBillerCodeDialog()
    {
        ...
        {
            BillerCodeDialog = new JDialog(PHMain.phFrame, PHController.posModule + " PH Biller Codes");
    ...
    {//GEN-HEADEREND:event_saveButtonActionPerformed
        ...
        else
        {
            ...
            eIBillerCode.setModifiedBy(EILogin.getAdminName());
    ...
    private void verifyAccount()
    {
        ...
        if (!"".equals(acctNoField.getText().trim()))
        {
            ...
            CNAccount cNAccount = tDClient.queryGLAccount(acctNoField.getText().trim());
...
//        return currencyNode != null ? currencyNode.getUserObject().toString().split("~")[0].trim() : MOBController.PrimaryCurrencyCode;
//    }
    ...
    private void verifyBiller()
    {
        ...
        if (PHController.getPosBillerCode().containsKey(billerCode))
        {
    ...
    public void searchBillerCode()
    {
        ...
        for (EIBillerCode billerCode : PHController.getPosBillerCode().values())
        {
    ...
    {
        PHController.loadPosBillerCodes();
...
//        for (EIProCodesMOB procCode : MOBController.getProcessingCode().values())
//        {
...
//        }
        PHController.getPosBillerCode().values().stream().map((billerCode) -> new DefaultMutableTreeNode(billerCode)).forEach((node)
                ->
                {
