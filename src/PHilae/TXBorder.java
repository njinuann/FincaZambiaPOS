 ...
 * @author Pecherk
 */
public class TXBorder extends TitledBorder
{
    protected JComponent component;

    public TXBorder(JComponent component)
    {
        this(null, component, LEFT, TOP);
    }

    public TXBorder(Border border)
    {
        this(border, null, LEFT, TOP);
    }

    public TXBorder(Border border, JComponent component)
    {
        this(border, component, LEFT, TOP);
    }

    public TXBorder(Border border, JComponent component, int titleJustification, int titlePosition)
    {
