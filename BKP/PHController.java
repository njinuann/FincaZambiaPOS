...
public class PHController
{
    ...
    public static long ChannelID = 8L, SystemUserID, ChannelSchemeID, defaultBURole = -99L;
    ...
    public static String confDir = "conf", ChannelCode = "POS", defaultSystemUser = "SYSTEM";
    public static String confDirMob = "mobile/conf", ChannelCodeMob = "MOB",logsDirMob = "mobile/logs";
    public static final Properties isoCodes = new Properties();
    private static final Properties xapiCodes = new Properties();
    public static String SuspendPOS = "Y", XapiUser, XapiPassword;
    ...
    public static String Module = "POS", AutoEnrollNewAccounts = "N", MobModule = "MOB";
    public static ArrayList processingTxnList = new ArrayList();
    public static String logsDir = "logs", CMSchemaName, BankBin;
    ...
    private static final ArrayList<TXProcessor> availableProcessors = new ArrayList<>();
    ...
    private static HashMap<String, EICharge> charges = new HashMap<>();
    ...
    public static String CustomersFileURL, BalancesFileURL, FileLoadWsdlURL;
    public static String AccountStatementsFileURL, AllowedProductIDs, AllowedLoginRoles;
    ...
    public static void initialize()
    {
        ...
        {
            new Thread(PHController::watchProcessors).start();
        }
    }
    ...
    public static boolean querySettings()
    {
        ...
        AllowedLoginRoles = getSetting("AllowedLoginRoles");/*ADDED TO THE SETTINGS FOR EASIER CONFIGURATION OF THE USERS ALLOWED TO ACCESS BRIDGE CONFIG WINDOWS*/
    ...
    public static EICharge getCharge(String chargeCode)
    {
     ...
     * @return the charges
     */
    public static HashMap<String, EICharge> getCharges()
    {
        if (charges.isEmpty())
        {
            loadCharges();
     ...
     */
    public static void setCharges(HashMap<String, EICharge> aCharges)
    {
        charges = aCharges;
    }
    ...
    {
        if (BRMain.bridgeLog != null)
        {
            BRMain.bridgeLog.error(ex);
        }
        else if (ex instanceof Throwable)
        {
            StringBuilder logEvent = new StringBuilder("<event realm=\"" + BRMain.bridgeRealm + "\" datetime=\"" + new Date() + "\">");
            logEvent.append("\r\n").append("\t").append("<error>");
    ...
    public static TXProcessor fetchProcessor()
    {
    ...
    public static void releaseProcessor(TXProcessor tXProcessor)
    {
        ...
        while (BRMain.isRunning)
        {
            try
            {
                if (availableProcessors.size() < MinProcessorPoolSize)
                {
                    ...
                    {
                        availableProcessors.add(new TXProcessor());
                    }
                }
                Thread.sleep(5000);
            }
